         ...
         <SimpleGrid px={{ base: 0, md: 32 }} py={20}>
            <Box>
               <Flex align="center" direction={{ base: 'column', md: 'row' }}>
                  <Heading as="h1" size="4xl" mr={{ base: 0, md: 4 }} mb={{ base: 4, md: 0 }}>
         ...
         <Grid templateColumns="repeat(12, 1fr)" p={{ base: 0, md: 32 }}>
            ...
            >
               ...
               <Text>
                  ...
                  Minden cikkünk az IPFS protokollon keresztül van regisztrálva a <a href="https://subsocial.network/" style={{ color: 'blue' }}>Subsocial</a>-on, amely a Polkadot Parachain projektje.
               </Text>
               <br />
               <Text>
